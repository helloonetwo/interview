...
##   【 手写源码 】 Promise 第一步—— Promise 回调 +then 初步 实现    
...
##  【 手写源码 】  发布订阅 实现 单级异步+级联 then 方法  

- 1. 修改测试类      
- 2.  理解 单级异步 级联 then 执行步骤
...
## 【  手写源码 】   构建多异步+级联 then 【 第一种实现方式，首创实现方式 】  

- 1. 升级 Promise 类 实现 多级异步+级联 then    
- 2. 修改测试类  
